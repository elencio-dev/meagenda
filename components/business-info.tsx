  ...
  return (
    <div className="bg-[var(--coral-pale)] rounded-2xl p-6 lg:p-8">
      ...
      <div className="space-y-4">
        {address && (
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--ink)]">Localização</p>
        ...
        {business?.phone && (
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--ink)]">Contato</p>
      ...
      <div className="mt-6 pt-6 border-t border-[var(--coral-light)]/30">
        ...
        <p className="text-sm text-[var(--ink-60)]">Escolha o serviço, profissional, data e horário. Rápido e fácil.</p>
      </div>
    </div>
  )
}
